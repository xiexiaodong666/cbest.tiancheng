...
public class AccountPaymentResultServiceImpl implements AccountPaymentResultService {
    ...
    public void thirdPartyPaymentResultNotify(CbestPayBaseResp resp) {
        ...
        req.setAmount(fenToYuan(thirdPartyPaymentResultNotifyReq.getAmount()));
        req.setActualAmount(fenToYuan(thirdPartyPaymentResultNotifyReq.getAmount()));
        ...
        if(Objects.isNull(thirdPartyPaymentRequest)){
            ...
            thirdPartyPaymentRequest.setTransAmount(new BigDecimal(req.getAmount()));
