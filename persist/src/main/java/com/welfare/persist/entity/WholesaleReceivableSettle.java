...
/**
 * 批发应收结算账单(wholesale_receivable_settle)实体类
 *
 * @author Yuxiang Li
...
@TableName("wholesale_receivable_settle")
@ApiModel("批发应收结算账单")
public class WholesaleReceivableSettle extends Model<WholesaleReceivableSettle> implements Serializable {
