...
/**
 * (wholesale_receivable_settle_detail)实体类
 *
 * @author Yuxiang Li
...
@TableName("wholesale_receivable_settle_detail")
@ApiModel("")
public class WholesaleReceivableSettleDetail extends Model<WholesaleReceivableSettleDetail> implements Serializable {
