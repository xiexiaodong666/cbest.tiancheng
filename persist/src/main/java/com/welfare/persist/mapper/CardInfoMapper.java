...
public interface CardInfoMapper extends BaseMapper<CardInfo> {
  ...
  public Page<CardInfoDTO> list(Page<CardInfo> page,@Param("cardId")  Long cardId,@Param("applyCode") String applyCode,
  ...
  public List<CardInfoDTO> exportCardInfo(@Param("cardId")  Long cardId, @Param("cardName") String cardName,
