...
INSERT INTO `sequence`(`id`, `sequence_type`, `prefix`, `sequence_no`, `min_sequence`, `max_sequence`, `handler_for_max`, `create_user`, `create_time`, `update_user`, `update_time`, `deleted`, `version`) VALUES (22, 'construction_bank_auto_inr', NULL, 0, 0, 9999999999, 'com.welfare.service.sequence.CommonMaxHandler', 'anonymous', now(), 'duanhy', now(), 0, 0);
